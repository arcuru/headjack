...
- Allow empty test suite in nextest

### Features

- Drop E2E encryption and sqlite store dependency
- Upgrade matrix-sdk 0.7 -> 0.16
- [**breaking**] Redesign API — BotConfig::login() → Bot, generic handlers, retry
...
- Update deps, drop lazy_static and unused rand
- Adopt arcuru/actions ([#19](https://github.com/arcuru/headjack/pull/19))
